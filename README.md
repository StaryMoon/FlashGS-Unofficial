...
<p align="center">
  <img src="assets/paper-preview.png" alt="FlashGS-Unofficial paper or project page preview" width="900">
</p>
...
| Item | Details |
|---|---|
| Paper | FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering |
| Venue / Source | CVPR 2025 |
| Focus | This repository organizes a PyTorch implementation for FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering, focusing on efficient large-scale... |
...
This repository organizes a PyTorch implementation for **FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering**, focusing on efficient large-scale high-resolution Gaussian splatting. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```python
import torch
from flashgs_unofficial import ModelConfig, UnofficialModel, reconstruction_loss
...
```python
import torch
from flashgs_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables, pp. 26652-26662 | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Feng_FlashGS_Efficient_3D_Gaussian_Splatting_for_Large-scale_and_High-resolution_Rendering_CVPR_2025_paper.html) |
| Ablation study | Ablation / experiment section | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Feng_FlashGS_Efficient_3D_Gaussian_Splatting_for_Large-scale_and_High-resolution_Rendering_CVPR_2025_paper.html) |
| Qualitative examples | Main paper figures and supplemental material | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Feng_FlashGS_Efficient_3D_Gaussian_Splatting_for_Large-scale_and_High-resolution_Rendering_CVPR_2025_paper.html) |
...
- Thanks to the authors of **FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering** for the original research.
...
cvpr-2025, pytorch, unofficial-implementation, gaussian-splatting, large-scale-rendering, 3d-reconstruction
